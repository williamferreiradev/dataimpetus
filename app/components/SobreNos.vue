<template>
  <section id="equipe" class="py-32 bg-[#0A1128] border-t border-[#1C2A4A]">
    <div class="container mx-auto px-6">
      <div class="text-center mb-16">
        <h2 class="text-3xl md:text-5xl font-bold text-white mb-4">Quem Somos</h2>
        <p class="text-gray-400 max-w-2xl mx-auto text-lg">A equipe da <strong class="text-[#00E0FF]">Data Impetus</strong> dedicada a escalar o seu negócio de assessoria e cerimonial.</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-[#1C2A4A] rounded-2xl p-8 border border-gray-800 hover:border-[#00E0FF]/50 transition-all group">
          ...
          <p class="text-gray-400 text-center text-sm">Focado em entender a sua dor como cerimonialista e traçar a melhor estratégia de oferta para seu site vender no piloto automático.</p>
        </div>
        ...
        <div class="bg-[#1C2A4A] rounded-2xl p-8 border border-gray-800 hover:border-[#00E0FF]/50 transition-all group">
          ...
          <p class="text-gray-400 text-center text-sm">O arquiteto responsável por garantir que seu site seja absurdamente rápido, seguro e construído com tecnologia de ponta para ranquear bem.</p>
        </div>
